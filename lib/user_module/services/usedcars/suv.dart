            ...
            Container(
              ...
              child: GridView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return InkWell(
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>detail_page_car(img: rentcarmodel3[index]['img'],
                          name: rentcarmodel3[index]['name'],
                          dis: rentcarmodel3[index]['dis'],
                          rate: rentcarmodel3[index]['rate'],
                          cc: rentcarmodel3[index]['cc'],
                          milege: rentcarmodel3[index]['milege'],
                          disc: rentcarmodel3[index]['disc'],
                          year: rentcarmodel3[index]['year'])));
                    },
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              ...
                              child: Image(image: AssetImage('assets/usedcars/${rentcarmodel3[index]['img']}'),fit: BoxFit.cover,),
                            ),
                            Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Text('${rentcarmodel3[index]['name']}',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),),
                                Padding(
                                  padding: const EdgeInsets.symmetric(horizontal: 4.0),
                                  child: Text('${rentcarmodel3[index]['rate']} ',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16,color: Colors.green),),
                                ),
