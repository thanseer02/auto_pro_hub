            ...
            Container(
              ...
              child: GridView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return InkWell(
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>detail_page_car(img: rentcarmodel1[index]['img'],
                          name: rentcarmodel1[index]['name'],
                          dis: rentcarmodel1[index]['dis'],
                          rate: rentcarmodel1[index]['rate'],
                          cc: rentcarmodel1[index]['cc'],
                          milege: rentcarmodel1[index]['milege'],
                          disc: rentcarmodel1[index]['disc'],
                          year: rentcarmodel1[index]['year'])));
                    },
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              ...
                              child: Image(image: AssetImage('assets/usedcars/${rentcarmodel1[index]['img']}'),fit: BoxFit.cover,),
                            ),
                            Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Text('${rentcarmodel1[index]['name']}',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),),
                                Padding(
                                  padding: const EdgeInsets.symmetric(horizontal: 4.0),
                                  child: Text('${rentcarmodel1[index]['rate']} ',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16,color: Colors.green),),
                                ),
