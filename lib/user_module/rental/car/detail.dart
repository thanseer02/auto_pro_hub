...
class detail_car extends StatefulWidget {
  detail_car({Key? key,required this.img,required this.name,required this.dis,required this.rate,required this.cc,required this.milege,required this.disc,required this.year}) : super(key: key);
  var img,name,dis,cc,milege,disc,year,rate;

  @override
  State<detail_car> createState() => _detail_carState();
}

class _detail_carState extends State<detail_car> {
  @override
