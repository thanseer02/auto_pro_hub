                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              ...
                              child: Image(image: AssetImage('assets/bikes/${usedbikemodel[index]['img']}'),fit: BoxFit.cover,),
                            ),
                            Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Text('${usedbikemodel[index]['name']}',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),),
                                Padding(
                                  padding: const EdgeInsets.symmetric(horizontal: 4.0),
                                  child: Text('${usedbikemodel[index]['rate']} ',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16,color: Colors.green),),
                                ),
